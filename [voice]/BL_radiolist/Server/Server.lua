...
RegisterNetEvent('dt-radiolist:SV:RemoveAllUI')
AddEventHandler('dt-radiolist:SV:RemoveAllUI', function()
    local src = source
    TriggerClientEvent("RemoveAllById:RadioList", -1, src, "remove", "", "")
end)
RegisterNetEvent('dt-radiolist:SV:AddAllUI')
AddEventHandler('dt-radiolist:SV:AddAllUI', function(mhz)
    local src = source
